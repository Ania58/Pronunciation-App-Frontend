    ...
    <div className="min-h-screen bg-gradient-to-b from-cyan-50 via-white to-cyan-100 flex flex-col">
      <main className="flex-grow max-w-3xl mx-auto px-4 py-8 animate-fade-in-up transition-all duration-700">
        ...
        <div className="mt-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <button onClick={() => navigate(-1)} className="inline-block bg-gray-200 hover:bg-gray-300 text-gray-800 px-5 py-2 rounded shadow cursor-pointer transform transition-transform duration-300 hover:scale-105">
          ⬅ {t('goBack')}
          </button>
          <Link
            to="/"
            className="text-sm text-gray-700 hover:text-indigo-700 bg-white hover:bg-indigo-50 px-4 py-2 rounded-lg shadow-sm transition transform transition-transform duration-300 hover:scale-105"
          >
            🏠 {t('home')}
          </Link>
          <LanguageSwitcher />
