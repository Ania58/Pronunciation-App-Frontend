    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-200 via-violet-200 to-lime-200 flex flex-col justify-between">
      <div className="max-w-5xl w-full mx-auto px-6 py-10 animate-fade-in text-lime-100">
        ...
        <div className="flex justify-end mb-6">
          <div className="[&>div>button]:bg-white [&>div>button]:text-black [&>div>button]:border-white [&>div>button]:shadow-none [&>div>button]:transition-none [&>div>button]:hover:bg-white [&>div>button]:hover:text-black [&>div>button.bg-blue-600]:bg-blue-600 [&>div>button.bg-blue-600]:text-white">
            <LanguageSwitcher />
          </div>
        </div>
        ...
        <Link
          to="/"
          className="text-violet-700 hover:text-violet-900 hover:underline mb-6 block font-semibold transition duration-300"
        >
          🏠 {t('home')}
        </Link>
